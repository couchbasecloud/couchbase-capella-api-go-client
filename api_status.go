...
func (r ApiStatusShowRequest) Execute() (StatusOK, *_nethttp.Response, error) {
	return r.ApiService.StatusShowExecute(r)
}
...
func (a *StatusApiService) StatusShowExecute(r ApiStatusShowRequest) (StatusOK, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  StatusOK
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatusApiService.StatusShow")
	if err != nil {
